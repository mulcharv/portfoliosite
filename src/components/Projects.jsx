    ...
    <section id='projects'>
      <div className='projectscont'>
        ...
        <div className='projectsection'>
          <a href='https://seatswap.netlify.app/' target='_blank'>
            <div className='projecttile'>
              <img className='projectimg' src={'/SeatSwap.png'}></img>
              <div className='projectrightside'>
                ...
                <div className='tilelinkscont'>
                  <div className='tilelinks'>
                    <a
                      href='https://github.com/SeatSwapAir/seat-swap-be'
                      target='_blank'
                    >
                      <img
                        className='tilelinkimg'
          ...
          <a
            href='https://elaborate-maamoul-c9d4b1.netlify.app/'
            target='_blank'
          >
            <div className='projecttile'>
              ...
              <div className='projectrightside'>
                ...
                <div className='tiledesc'>
                  A fullstack app for users to buy and sell stocks for gains and
                  losses.
                </div>
                <div className='tilelangs'>
                  Node.js, Express.js, MongoDB, bcrypt, Passport.js, React,
                  Chart.js
                </div>
                <div className='tilelinkscont'>
                  <div className='tilelinks'>
                    <a
                      href='https://github.com/mulcharv/tradingfrontend'
                      target='_blank'
                    >
                      <img
                        className='tilelinkimg'
          ...
          <a
            href='https://cerulean-seahorse-473a4d.netlify.app/'
            target='_blank'
          >
            <div className='projecttile'>
              ...
              <div className='projectrightside'>
                ...
                <div className='tiledesc'>
                  A fullstack app for users to post and comment on the London
                  music scene.
                </div>
                <div className='tilelangs'>
                  Node.js, Express.js, MongoDB, bcrypt, Passport.js, React
                ...
                <div className='tilelinkscont'>
                  <div className='tilelinks'>
                    <a
                      href='https://github.com/mulcharv/blogfrontend'
                      target='_blank'
                    >
                      <img
                        className='tilelinkimg'
          ...
          <a href='https://mulcharv.github.io/shopping-cart/' target='_blank'>
            <div className='projecttile'>
              ...
              <div className='projectrightside'>
                ...
                <div className='tiledesc'>
                  A front end mock e-commerce store for the Toronto Raptors.
                </div>
                <div className='tilelangs'>React, Javascript, CSS</div>
                <div className='tilelinkscont'>
                  <div className='tilelinks'>
                    <a
                      href='https://github.com/mulcharv/shopping-cart'
                      target='_blank'
                    >
                      <img
                        className='tilelinkimg'
                  ...
                  <div className='tilelinks'>
                    <a
                      href='https://mulcharv.github.io/shopping-cart/'
                      target='_blank'
                    >
                      <img
                        className='tilelinkimg'
          ...
          <a href='https://mulcharv.github.io/battleshipgame/' target='_blank'>
            <div className='projecttile'>
              ...
              <div className='projectrightside'>
                ...
                <div className='tiledesc'>
                  A web based human-computer version of the game battleship.
                </div>
                <div className='tilelangs'>Javascript, CSS, Webpack</div>
                <div className='tilelinkscont'>
                  <div className='tilelinks'>
                    <a
                      href='https://github.com/mulcharv/battleshipgame'
                      target='_blank'
                    >
                      <img
                        className='tilelinkimg'
                  ...
                  <div className='tilelinks'>
                    <a
                      href='https://mulcharv.github.io/battleshipgame/'
                      target='_blank'
                    >
                      <img
                        className='tilelinkimg'
